...
import { indiaMarketSaturationPath } from '@/lib/indiaMarketSaturationData'
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${SITE_URL}/india/digital-battlefield/market-saturation` },
}
...
export default async function MarketSaturationHubPage() {
  ...
  if (error) {
    console.error('[india/digital-battlefield/market-saturation hub] Fetch failed:', error.message)
  }
  ...
  return (
    <MarketingShell className="max-w-6xl gap-10">
      ...
      <PseoHubGrid
        items={rows.map((row) => ({
          href: indiaMarketSaturationPath(row.slug),
