...
export type WhitespaceScoreSize = 'sm' | 'md' | 'lg'

export interface WhitespaceScoreProps {
  score: number
  size?: WhitespaceScoreSize
  className?: string
  /** Accessible label for the score readout */
  label?: string
}
...
const BAND_BAR_CLASS: Record<ScoreBand, string> = {
  low: 'bg-red-500 shadow-[0_0_24px_-4px_rgba(239,68,68,0.65)]',
  mid: 'bg-amber-500 shadow-[0_0_24px_-4px_rgba(245,158,11,0.65)]',
  high: 'bg-emerald-500 shadow-[0_0_24px_-4px_rgba(16,185,129,0.65)]'
}
