...
export function GhostGate() {
  return (
    <section className="relative overflow-hidden rounded-lg border border-orange-500/20 bg-zinc-950 px-6 py-6 text-zinc-100 sm:px-8 sm:py-7">
      {/* Scanline overlay */}
      ...
      <div className="space-y-2">
        <h2 className="font-mono text-sm font-semibold uppercase tracking-[0.28em] text-zinc-200">
      ...
      <div className="mt-5 grid gap-3 text-xs text-zinc-300 sm:grid-cols-3">
        <div className="flex items-start gap-3 rounded-md border border-zinc-800 bg-black/40 px-3 py-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-zinc-200">Injecting Economics</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3 rounded-md border border-zinc-800 bg-black/40 px-3 py-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-zinc-200">Mapping Competitors</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3 rounded-md border border-zinc-800 bg-black/40 px-3 py-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-zinc-200">Syncing Authority</p>
          </div>
        </div>
      </div>
    </section>
